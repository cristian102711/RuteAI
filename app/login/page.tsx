  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err?.message === "Failed to fetch") {
        toast.error("Error de conexión: Tu base de datos de Supabase parece estar pausada. Por favor, ve a app.supabase.com para reactivarla.", { id: "auth", duration: 10000 });
      } else {
        toast.error("Ocurrió un error inesperado al conectar.", { id: "auth" });
      }
    } finally {
      setIsLoading(false);
    }
