  ...
  return (
    <form action={handleAction} className="flex flex-col gap-5">
      <div className="flex flex-col gap-1.5">
        <label className="text-[10px] font-bold text-muted-foreground tracking-widest uppercase ml-1">
          Destinatario
        </label>
        <input
          name="cliente"
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-[10px] font-bold text-muted-foreground tracking-widest uppercase ml-1">
          Teléfono Destinatario (SMS/WhatsApp)
        </label>
        <input
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          required
          className={`${INPUT_CLASS} font-bold uppercase tracking-wider`}
          disabled={isSubmitting}
        />
      </div>
      ...
      >
        {isSubmitting ? (
          ...
          <>
            <Zap strokeWidth={2.5} className="w-4 h-4 group-hover:scale-110 transition-transform" />
            Iniciar Tracking e IA
          </>
        )}
      </button>
    </form>
