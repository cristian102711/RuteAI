...
export default async function EquipoPage() {
  ...
  // Todos los repartidores de la empresa con sus datos relacionados
  const repartidores = await prisma.usuario.findMany({
    ...
    include: {
      // Contar pedidos totales asignados
      _count: { select: { pedidosAsignados: true } },
      // Pedidos activos hoy (en_ruta o pendiente)
      pedidosAsignados: {
    ...
    <div className="space-y-6 p-6 lg:p-8 max-w-7xl mx-auto text-zinc-100 selection:bg-purple-500/30">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={stat.label}
            className="rounded-xl border border-white/[0.04] bg-white/[0.02] p-4 backdrop-blur"
          >
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-white/[0.03]">
              {repartidores.map((rep) => {
                ...
                // Coordenadas legibles como referencia de zona
