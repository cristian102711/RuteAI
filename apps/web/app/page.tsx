...
import {
  Route, ArrowRight, Sparkles, Fuel, Clock, Zap,
  Check, Github, Twitter, Linkedin, Building2, Radio, Shield,
} from "lucide-react";
import {
  SlideUp, SlideRight, SlideLeft, FadeIn,
  StaggerChildren, StaggerItem, MotionCard, ScaleIn,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 selection:bg-amber-500/30">
      ...
      <motion.header
        ...
        className="sticky top-0 z-40 border-b border-zinc-800 bg-zinc-950/70 backdrop-blur-xl"
      >
          ...
          <div>
            ...
            <SlideUp delay={0.36}>
              <div className="mt-10 grid grid-cols-3 gap-6 border-t border-zinc-800 pt-6">
                {[
                  { icon: Fuel, label: "Combustible", value: "−38%" },
                  { icon: Clock, label: "Ahorro / día",  value: "2.4 h" },
                  { icon: Zap,  label: "Entregas a tiempo", value: "98.6%" },
      ...
      <FadeIn>
        <section className="border-y border-zinc-800 bg-white/5 py-8">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <StaggerChildren fast className="mt-6 grid grid-cols-2 gap-x-8 gap-y-4 text-center text-sm font-medium text-zinc-500/70 md:grid-cols-6">
              {["Mercado Andino", "Farmacias Pacífico", "Sushi Express", "Cervecería Tropical", "Petfood Andes", "Floristería Camelia"].map(name => (
      ...
      <section id="features" className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <StaggerChildren className="mt-12 grid gap-4 md:grid-cols-2">
            {[
              { badge: "IA",         icon: Sparkles,  title: "Optimización de rutas",      desc: "Algoritmos genéticos + modelos de tráfico en tiempo real recalculan tu flota en menos de 800 ms." },
              { badge: "Live",       icon: Radio,     title: "Monitoreo GPS en vivo",      desc: "Cada repartidor reporta cada 5 segundos. Geocercas, paradas no autorizadas y tiempos de detención." },
              { badge: "Predictivo", icon: Shield,    title: "Score de riesgo de entrega", desc: "Asignamos un porcentaje de fallo a cada pedido usando historial del cliente, dirección y meteorología." },
              { badge: "Multi-tenant",icon: Building2, title: "Arquitectura SaaS",         desc: "Aislamiento por empresa, permisos granulares, SSO y APIs REST/Webhooks listas para escalar." },
            ].map((f) => (
              <StaggerItem key={f.title}>
                <MotionCard className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 transition hover:border-zinc-700 hover:bg-zinc-800/40 cursor-default">
      ...
      <section id="how" className="border-t border-zinc-800 bg-zinc-900/20 py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <StaggerChildren className="mt-12 grid gap-4 md:grid-cols-3">
            {[
              ...
              <StaggerItem key={step.num}>
                <div className="relative rounded-2xl border border-zinc-800 bg-zinc-950 p-7">
      ...
      <section id="pricing" className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <StaggerChildren className="mt-14 grid gap-4 md:grid-cols-3">
            {/* Starter */}
            <StaggerItem>
              <div className="relative rounded-2xl border p-7 border-zinc-800 bg-zinc-900/20 h-full">
            ...
            <StaggerItem>
              <motion.div
                ...
                className="relative rounded-2xl border p-7 border-amber-500/40 bg-gradient-to-b from-amber-500/10 to-purple-500/10 shadow-[0_0_30px_rgba(245,158,11,0.2)] h-full"
              >
        ...
        <footer className="border-t border-zinc-800">
          <div className="mx-auto max-w-7xl px-6 py-14">
            <div className="grid gap-10 md:grid-cols-5">
              ...
              {[
                { title: "Producto", links: ["Features", "Precios", "Cambios", "Roadmap"] },
                { title: "Empresa",  links: ["Clientes", "Blog", "Carreras", "Contacto"] },
                { title: "Legal",    links: ["Privacidad", "Términos", "DPA", "SOC 2"] },
              ].map(col => (
                <div key={col.title}>
            ...
            <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-zinc-800 pt-6 text-xs text-zinc-500">
              <div>© 2026 RouteAI Labs S.A.S. — Santiago · CDMX · Buenos Aires</div>
